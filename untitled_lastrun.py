...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hp\\Desktop\\PSY310 LAB IN PSYCH\\TUT_4\\untitled_lastrun.py',
...
trials = data.TrialHandler(nReps=96.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/hp/Desktop/PSY310 LAB IN PSYCH/TUT_4/conditions_file.csv'),
...
# set up handler to look after randomisation of conditions etc
trials_2 = data.TrialHandler(nReps=96.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/hp/Desktop/PSY310 LAB IN PSYCH/TUT_4/conditions_file.csv'),
